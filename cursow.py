...
class cursow(object):
    ...
    def colorCheck(self): ## {{{
        if curses.can_change_color() and curses.COLORS > 10:
            ...
            curses.init_color(0,0000,0000,0000)
            curses.init_color(1,1000,0000,0000)
            curses.init_color(2,0000,1000,0000)
            curses.init_color(3,1000,1000,0000)
            curses.init_color(4,0000,0000,1000)
            curses.init_color(5,0000,1000,1000)
            curses.init_color(6,1000,0000,1000)
